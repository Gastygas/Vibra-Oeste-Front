...
const Section2 = () => {
    const photos: string[] =[
        ...
        "https://res.cloudinary.com/dbmfju6mu/image/upload/v1732248331/c_jqnqsu.png",
        "https://res.cloudinary.com/dbmfju6mu/image/upload/v1732248602/e_ippd9u.jpg",
        "https://res.cloudinary.com/dbmfju6mu/image/upload/v1732248779/Screenshot_2024-11-22_011154_vhk7hm.png",
    ]
    return(
